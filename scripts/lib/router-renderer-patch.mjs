...
const RRouterProviders=[
  ...
  {value:"vcoder",label:"VCoder",description:"Use your local VCoder CLI sign-in with Grok Bot's connected plugins.",kind:"local",localKey:"vcoder"},
